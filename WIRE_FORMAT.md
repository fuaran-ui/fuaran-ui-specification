...
<!-- fuaran:count kind=total -->470<!-- /fuaran:count --> fixtures in all —
<!-- fuaran:count kind=node-round-trip -->202<!-- /fuaran:count --> `node-round-trip`,
<!-- fuaran:count kind=op-round-trip -->23<!-- /fuaran:count --> `op-round-trip`,
<!-- fuaran:count kind=reject -->127<!-- /fuaran:count --> `reject`,
