...
<!-- fuaran:count kind=total -->510<!-- /fuaran:count --> fixtures in all —
<!-- fuaran:count kind=node-round-trip -->216<!-- /fuaran:count --> `node-round-trip`,
<!-- fuaran:count kind=op-round-trip -->23<!-- /fuaran:count --> `op-round-trip`,
<!-- fuaran:count kind=reject -->150<!-- /fuaran:count --> `reject`,
