...
<!-- fuaran:count kind=total -->468<!-- /fuaran:count --> fixtures in all —
<!-- fuaran:count kind=node-round-trip -->201<!-- /fuaran:count --> `node-round-trip`,
<!-- fuaran:count kind=op-round-trip -->23<!-- /fuaran:count --> `op-round-trip`,
<!-- fuaran:count kind=reject -->126<!-- /fuaran:count --> `reject`,
